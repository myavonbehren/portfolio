...
export default function Dpulogo({ className, width = 24, height = 24 }: DpulogoProps) {
    return (
        <svg
            id="Layer_1"
        ...
        >
            ...
            <g id="Layer_6">
                <path
                    d="M12.22,22.12c-.15.04-.29.04-.44,0-1.45-.34-9.57-2.33-9.62-4.65-.08-3.11,0-14.03,0-15.61,0-.11.09-.19.2-.19h19.3c.11,0,.19.08.19.18.03,1.78,0,12.51,0,15.62,0,2.32-8.18,4.31-9.62,4.65h-.01Z"
                    fill="none"
                    stroke="var(--foreground)"
                    strokeMiterlimit={10}
                    strokeWidth={1.3}
